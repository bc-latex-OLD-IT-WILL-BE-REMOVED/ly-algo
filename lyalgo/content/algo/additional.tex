...
\begin{enumerate}
	...
	\item \textit{Ajout d'un nouvel élément à gauche.}
	      ...
	      En tapant \verb+\Prepend{L}{5}+, on obtient \myquote{\Prepend{L}{5}}
	      \footnote{
	...
	\item \textit{Extraction d'un élément.}
	      ...
	      En tapant \verb+\PopAt{L}{2}+, on obtient \myquote{\PopAt{L}{2}} avec un calcul automatique ici.
\end{enumerate}
...
\begin{enumerate}
	...
	\item \textit{Extraction d'un élément.}
	      ...
	      \verb+\PopAt*{L}{2}+ fournit \PopAt*{L}{2}.
\end{enumerate}
